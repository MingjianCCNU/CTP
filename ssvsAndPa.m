...
V0 = exp(2*r);
V1 = 3.*exp(1).^(2.*r);
V2 = (7+18.*exp(1).^(2.*r)+15.*exp(1).^(4.*r)).*(2+6.*cosh(2.*r)).^(-1) ...
  ;
V3 = (11+10.*exp(1).^(2.*r)+35.*exp(1).^(4.*r)).*((-2)+10.*cosh(2.*r)) ...
  .^(-1);
V4 = (132+15.*exp(1).^((-2).*r).*(5+7.*exp(1).^(4.*r).*(2+4.*exp(1).^( ...
  2.*r)+3.*exp(1).^(4.*r)))).*(18+40.*cosh(2.*r)+70.*cosh(4.*r)).^( ...
  -1);
V5 = (92+7.*exp(1).^((-2).*r).*(19+34.*exp(1).^(4.*r)+36.*exp(1).^(6.* ...
  r)+99.*exp(1).^(8.*r))).*(58+(-56).*cosh(2.*r)+126.*cosh(4.*r)).^( ...
  -1);
V6 = (1125+7.*exp(1).^((-4).*r).*(69+114.*exp(1).^(2.*r)+220.*exp(1).^( ...
  6.*r)+315.*exp(1).^(8.*r)+594.*exp(1).^(10.*r)+429.*exp(1).^(12.* ...
  r))).*(100+210.*cosh(2.*r)+252.*cosh(4.*r)+462.*cosh(6.*r)).^(-1); 
V7 = 3.*(479+3.*exp(1).^((-4).*r).*(99+62.*exp(1).^(2.*r)+11.*exp(1).^( ...
  6.*r).*(12+23.*exp(1).^(2.*r)+26.*exp(1).^(4.*r)+65.*exp(1).^(6.* ...
  r)))).*((-212)+774.*cosh(2.*r)+(-396).*cosh(4.*r)+858.*cosh(6.*r)) ...
  .^(-1);
V8 = exp(1).^(2.*r).*(1225+2520.*cosh(2.*r)+2772.*cosh(4.*r)+3432.* ...
  cosh(6.*r)+6435.*cosh(8.*r)).^(-1).*(49112.*cosh(2.*r)+56532.* ...
  cosh(4.*r)+87912.*cosh(6.*r)+61347.*cosh(8.*r)+7.*(3375+1696.* ...
  sinh(2.*r)+3936.*sinh(4.*r)+9504.*sinh(6.*r)+6864.*sinh(8.*r)));
